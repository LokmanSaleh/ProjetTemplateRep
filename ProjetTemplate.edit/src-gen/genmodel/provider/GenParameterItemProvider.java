 ...
 * @generated
 */
public class GenParameterItemProvider extends GenTypedElementItemProvider {
	/**
	...
	protected void addEcoreParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GenParameter_ecoreParameter_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_GenParameter_ecoreParameter_feature",
								"_UI_GenParameter_type"),
						GenmodelPackage.Literals.GEN_PARAMETER__ECORE_PARAMETER, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((GenParameter) object).getDocumentation();
		return label == null || label.length() == 0 ? getString("_UI_GenParameter_type")
