	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Accuracy_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Accuracy_value_feature",
								"_UI_Accuracy_type"),
						ProjetTemplatePackage.Literals.ACCURACY__VALUE, true, false, false,
