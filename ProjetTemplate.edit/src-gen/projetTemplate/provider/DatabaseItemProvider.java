...
/**
 * This is the item provider adapter for a {@link projetTemplate.Database} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatabaseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Database_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Database_value_feature",
								"_UI_Database_type"),
						ProjetTemplatePackage.Literals.DATABASE__VALUE, true, false, false,
	...
	protected void addCredentiasPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Database_credentias_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Database_credentias_feature",
								"_UI_Database_type"),
						ProjetTemplatePackage.Literals.DATABASE__CREDENTIAS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Database_schema_feature",
								"_UI_Database_type"),
						ProjetTemplatePackage.Literals.DATABASE__SCHEMA, true, false, true, null, null, null));
	}
	...
	protected void addDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Database_data_feature"),
	...
	public String getText(Object object) {
		String label = ((Database) object).getValue();
