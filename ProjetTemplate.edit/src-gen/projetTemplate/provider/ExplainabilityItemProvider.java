	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Explainability_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Explainability_value_feature",
								"_UI_Explainability_type"),
						ProjetTemplatePackage.Literals.EXPLAINABILITY__VALUE, true, false, false,
