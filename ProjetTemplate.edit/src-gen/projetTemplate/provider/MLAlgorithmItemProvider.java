 ...
 * @generated
 */
public class MLAlgorithmItemProvider extends ComponentItemProvider {
	/**
	...
	protected void addProcessingchaintemplatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MLAlgorithm_processingchaintemplate_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_MLAlgorithm_processingchaintemplate_feature",
						"_UI_MLAlgorithm_type"),
				ProjetTemplatePackage.Literals.ML_ALGORITHM__PROCESSINGCHAINTEMPLATE, true, false, true, null, null,
				null));
	}
