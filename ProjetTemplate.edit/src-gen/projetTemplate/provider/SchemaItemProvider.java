...
/**
 * This is the item provider adapter for a {@link projetTemplate.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTechnologyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Schema_technology_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Schema_technology_feature",
								"_UI_Schema_type"),
						ProjetTemplatePackage.Literals.SCHEMA__TECHNOLOGY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Modelelement feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addModelelementPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Schema_modelelement_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Schema_modelelement_feature",
								"_UI_Schema_type"),
						ProjetTemplatePackage.Literals.SCHEMA__MODELELEMENT, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Schema) object).getTechnology();
