...
/**
 * This is the item provider adapter for a {@link projetTemplate.SelectionCriterion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SelectionCriterionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_SelectionCriterion_name_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_SelectionCriterion_name_feature",
						"_UI_SelectionCriterion_type"),
				ProjetTemplatePackage.Literals.SELECTION_CRITERION__NAME, true, false, false,
	...
	protected void addValueTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_SelectionCriterion_valueType_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_SelectionCriterion_valueType_feature",
						"_UI_SelectionCriterion_type"),
				ProjetTemplatePackage.Literals.SELECTION_CRITERION__VALUE_TYPE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_SelectionCriterion_description_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_SelectionCriterion_description_feature",
						"_UI_SelectionCriterion_type"),
	...
	public String getText(Object object) {
		String label = ((SelectionCriterion) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_SelectionCriterion_type")
				: getString("_UI_SelectionCriterion_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SelectionCriterion.class)) {
