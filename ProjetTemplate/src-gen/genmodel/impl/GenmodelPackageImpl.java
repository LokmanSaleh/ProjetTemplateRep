...
import projetTemplate.impl.ProjetTemplatePackageImpl;
...
public class GenmodelPackageImpl extends EPackageImpl implements GenmodelPackage {
	...
	public static GenmodelPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(ProjetTemplatePackage.eNS_URI);
		ProjetTemplatePackageImpl theProjetTemplatePackage = (ProjetTemplatePackageImpl) (registeredPackage instanceof ProjetTemplatePackageImpl
				? registeredPackage
				: ProjetTemplatePackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGenPackage_LoadInitializationFileExtension(), ecorePackage.getEString(),
				...
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGenPackage_FamilyTreeInitialization(), ecorePackage.getEBoolean(), "familyTreeInitialization",
				null, 0, 1, GenPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(genJDKLevelEEnum, GenJDKLevel.JDK180);
		addEEnumLiteral(genJDKLevelEEnum, GenJDKLevel.JDK190);
		addEEnumLiteral(genJDKLevelEEnum, GenJDKLevel.JDK200);
